...
const Navbar = () => {
  ...
  return (
    <div className='flex items-center justify-between text-sm py-4 mb-5 border-b border-b-gray-40'>
      <img onClick={()=>navigate('/')} className='w-44 cursor-pointer' src={assets.docbook_logo_new} alt=""/>
      ...
      <div className='flex items-center gap-4'>
          {
            ...
            ? <div className='flex items-center gap-2 cursor-pointer group relative'>
                  <img className='w-8 rounded-full' src={userData ? userData.image : assets.profile_pic} alt=''></img>
          ...
          <div className={` ${showMenu ? 'fixed w-full':'h-0 w-0'} md:hidden right-0 top-0 bottom-0 z-20 overflow-hidden bg-white transition-all`}>
            <div className='flex items-center justify-between px-5 py-6'>
              <img className='w-36' src={assets.docbook_logo_new} alt="" />
